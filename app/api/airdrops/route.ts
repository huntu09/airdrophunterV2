...
const MOCK_AIRDROPS = [
  ...
  },
  {
    ...
    name: "Scroll Airdrop",
    logo: "/placeholder.svg?height=40&width=40",
    description: "zkEVM Layer 2 on Ethereum with potential airdrop",
    action: "Interact with Scroll network",
    category: "potential",
    rating: 4.2,
    totalRatings: 800,
    status: "active",
    ...
    about: {
      overview: "Scroll is a zkEVM Layer 2 scaling solution for Ethereum.",
      tokenomics: "Token details to be announced.",
      roadmap: "Testnet ongoing, mainnet launch in 2024",
    },
    steps: ["Bridge assets to Scroll", "Deploy contracts", "Test dApps"],
    requirements: ["Active participation", "Provide feedback"],
    isHot: true,
    isConfirmed: false,
    participants: 15000,
    networks: ["Scroll"],
  ...
  },
  {
    ...
    name: "Linea Airdrop",
    logo: "/placeholder.svg?height=40&width=40",
    description: "ConsenSys' zkEVM Layer 2 with potential rewards",
    action: "Use Linea for various activities",
    category: "potential",
    rating: 4.3,
    totalRatings: 900,
    status: "active",
    ...
    about: {
      overview: "Linea is a zkEVM Layer 2 network by ConsenSys.",
      tokenomics: "Token details to be announced.",
      roadmap: "Mainnet launch in 2024",
    },
    steps: ["Bridge assets to Linea", "Interact with dApps", "Provide feedback"],
    requirements: ["Active participation", "Test network features"],
    isHot: true,
    isConfirmed: false,
    participants: 18000,
    networks: ["Linea"],
  ...
  },
  {
    ...
    action: "Participate in Taiko testnets",
    category: "potential",
    rating: 4.1,
    totalRatings: 750,
    status: "active",
    ...
    about: {
      overview: "Taiko is a decentralized ZK-Rollup, Ethereum-equivalent.",
      tokenomics: "Token details to be announced.",
      roadmap: "Ongoing testnets, mainnet launch in future",
    },
    steps: ["Run a node", "Bridge assets", "Test dApps"],
    requirements: ["Technical knowledge", "Active participation"],
    isHot: false,
    isConfirmed: false,
    participants: 12000,
    networks: ["Taiko"],
  ...
  },
  {
    ...
    name: "Base Airdrop",
    logo: "/placeholder.svg?height=40&width=40",
    description: "Coinbase's Ethereum Layer 2 network",
    action: "Use Base network for transactions",
    category: "potential",
    rating: 4.4,
    totalRatings: 1000,
    status: "active",
    ...
    about: {
      overview: "Base is an Ethereum Layer 2 network by Coinbase.",
      tokenomics: "Token details to be announced.",
      roadmap: "Ecosystem growth and new features",
    },
    steps: ["Bridge assets to Base", "Use dApps on Base", "Provide feedback"],
    requirements: ["Active participation", "Explore the ecosystem"],
    isHot: true,
    isConfirmed: false,
    participants: 20000,
    networks: ["Base"],
