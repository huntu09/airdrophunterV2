...
DROP TABLE IF EXISTS user_airdrops CASCADE;
...
-- Create trigger for airdrops updated_at
...
CREATE INDEX idx_airdrops_rating ON airdrops(rating);
...
CREATE INDEX idx_user_airdrops_status ON user_airdrops(status);
