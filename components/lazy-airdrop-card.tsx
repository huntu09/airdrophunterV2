            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className="text-lg sm:text-xl font-medium text-gray-900 dark:text-white">{airdrop.name}</h3>
              ...
              <div className="flex flex-col gap-2 w-full">
                <Button
                  variant="ghost"
                  size="sm"
                  className="bg-gray-100 dark:bg-[#3a3a3a] hover:bg-gray-200 dark:hover:bg-[#4a4a4a] text-gray-700 dark:text-gray-300 w-full h-12 transition-all duration-200 hover:scale-105" // Larger height for mobile
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button
                            ...
                            size="sm"
                            className={cn(
                              "h-12 w-12 p-0 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200 hover:scale-110", // Larger touch target
                              social.color,
                            )}
                            asChild
                          >
